...
internal class CrtAsyncV2IT : S3TestBase() {
    ...
    fun testMultipartUpload(testInfo: TestInfo) {
        ...
        val completeMultipartUploadResponseCompletableFuture = autoS3CrtAsyncClientV2.completeMultipartUpload(
        ...
        // verify special etag
        Assertions.assertThat(completeMultipartUploadResponse.eTag()).`as`("Special etag doesn't match.")
