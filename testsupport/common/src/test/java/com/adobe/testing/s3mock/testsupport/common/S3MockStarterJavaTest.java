...
import static com.adobe.testing.s3mock.testsupport.common.S3MockStarter.PROP_INITIAL_BUCKETS;
...
class S3MockStarterJavaTest {
  ...
  void testS3MockApplication() {
    ...
    properties.put(PROP_INITIAL_BUCKETS, "bucket");
