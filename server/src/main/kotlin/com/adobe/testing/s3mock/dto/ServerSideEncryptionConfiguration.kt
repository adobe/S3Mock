...
/**
 * [API Reference](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ServerSideEncryptionConfiguration.html).
 */
@S3Verified(year = 2025)
@JsonRootName("ServerSideEncryptionConfiguration", namespace = "http://s3.amazonaws.com/doc/2006-03-01/")
data class ServerSideEncryptionConfiguration(
  ...
  val rules: List<ServerSideEncryptionRule>?,
)
