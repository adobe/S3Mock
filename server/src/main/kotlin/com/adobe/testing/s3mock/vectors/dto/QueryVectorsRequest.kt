...
data class QueryVectorsRequest
  ...
  constructor(
    ...
    @param:JsonProperty("queryVector") val queryVector: VectorData?,
    @param:JsonProperty("topK") val topK: Int?,
    @param:JsonProperty("filter") val filter: JsonNode?,
    @param:JsonProperty("returnDistance") val returnDistance: Boolean?,
