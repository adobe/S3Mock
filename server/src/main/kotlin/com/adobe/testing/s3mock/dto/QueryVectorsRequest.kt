 ...
 * [API Reference](https://docs.aws.amazon.com/AmazonS3/latest/API/API_QueryVectors_s3vectors.html)
 */
data class QueryVectorsRequest(
  ...
  @param:JsonProperty("QueryVector")
  val queryVector: VectorData?,
  @param:JsonProperty("ReturnDistance")
  val returnDistance: Boolean?,
